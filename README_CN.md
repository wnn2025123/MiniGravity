...
> ### 👑【核心主推】🔥 终极形态：原生通道推理 (Native Channel Inference / v6.0-pro+)
...
> #### 🕷️ 幽灵形态：uTLS 寄生模式 (Parasitic Mode / v6.0-ls)
> **主打：深度隐蔽 + 极限环境兜底**
...
> 这意味着在最新的 v6.0-ls 统合版本中，无论你在 Windows/Linux 环境，还是配备了 **M1/M2/M3 等苹果芯片的 Mac** 电脑上运行，Docker 都将自动为你拉取并运行零性能损耗、**绝非 Rosetta 模拟**的纯原生高效容器！
